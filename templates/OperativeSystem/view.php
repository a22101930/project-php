...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Operative System'), ['action' => 'edit', $operativeSystem->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Operative System'), ['action' => 'delete', $operativeSystem->id], ['confirm' => __('Are you sure you want to delete # {0}?', $operativeSystem->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Operative System'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Operative System'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="operativeSystem view content">
            <h3><?= h($operativeSystem->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($operativeSystem->machine)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($operativeSystem->machine as $machine) : ?>
                        <tr>
                            <td><?= h($machine->id) ?></td>
